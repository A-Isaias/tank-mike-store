		...
		<div class="col-md-9 item-info">
			...
			<ul class="list-unstyled">
				...
				<li>
					...
					<span>Consultar</span> : <a href="https://api.whatsapp.com/send?phone=3364338670&text=Hola! Me gustaría consultar sobre el tanque Cod: <?= $item['Country_Made'] ?> - <?= $item['Name'] ?> -- " target="_blank"><button class="btn-success">Enviar mensaje por WhatsApp</button></a>
				</li>
			</ul>
		</div>
	</div>
