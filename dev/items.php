		...
		<div class="col-md-9 item-info">
			...
			<ul class="list-unstyled">
				<li>
					...
					<span>Agregado</span> : <?php echo $item['Add_Date'] ?>
				</li>
				<li>
				...
				<li>
					...
					<span>Codigo</span> : <?php echo $item['Country_Made'] ?>
				</li>
				<li>
				...
				<!-- <li>
					...
					<span>Agregado por</span> : <a href="#"><?php echo $item['Username'] ?></a>
				</li> -->
				<li>
					<i class="fa fa-phone fa-fw"></i>
					<span>Consultar</span> : <a href="https://api.whatsapp.com/send?phone=3364338670&text=Hola! Me gustaría consultar sobre el tanque Cod: <?= $item['Country_Made'] ?> - <?= $item['Name'] ?> -- " target="_blank"><button class="btn btn-success">Enviar mensaje por WhatsApp</button></a>
				</li>
			</ul>
		</div>
	</div>
