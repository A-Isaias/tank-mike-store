...
<head>
	...
	<link rel="stylesheet" href="<?php echo $css ?>bootstrap-icons-1.11.3/font/bootstrap-icons.min.css">
			...
			<div class="container">
				...
				<!-- <div class="collapse navbar-collapse" id="navbarUserMenu"> -->
					...
					<div class="d-flex" role="search">
							<a class="btn btn-small btn-outline-success" href="https://api.whatsapp.com/send?phone=3364338670&text=Hola%21%20Quería%20consultar%20sobre%20los%20tanques%20para%20radiadores" target="_blank">Consultas <i class="bi bi-whatsapp"></i> 3364338670</a>
					</div>
				<!-- </div> -->
